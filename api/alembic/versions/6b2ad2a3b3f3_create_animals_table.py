...
def upgrade() -> None:
    ...
    sa.Column('adoption_status', sa.Enum('AVAILABLE', 'ADOPTED', 'ON_HOLD', name='animaladoptionstatus'), nullable=False),
    sa.Column('current_location', sa.Enum('FOSTERED', 'SHELTER', 'STRAY', name='animalcurrentlocation'), nullable=True),
