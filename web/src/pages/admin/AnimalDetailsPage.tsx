...
import AnimalPhotoManagement from "../../components/animals/AnimalPhotoManagement";
import DeleteAnimalModal from "../../components/animals/DeleteAnimalModal";
...
export default function AnimalDetailsPage() {
  ...
  if (error)
    return <div className="p-8 text-red-600">Error loading animal</div>;
  ...
  return (
    <>
      <div className="p-8 max-w-3xl mx-auto">
        ...
        <AnimalPhotoManagement
          animalId={animal.id}
          primaryPhotoUrl={animal.primary_photo_url}
          extraPhotosUrl={animal.extra_photos_url}
        />

        <div className="p-6">
          <div className="grid grid-cols-2 gap-4 w-full space-y-2">
            <div>
        ...
        <div className="flex justify-between content-start pt-4 border-t text-sm text-gray-400">
          ...
          <button
            onClick={() =>
              setDeleteModal({ id: animal?.id, name: animal?.name })
            }
